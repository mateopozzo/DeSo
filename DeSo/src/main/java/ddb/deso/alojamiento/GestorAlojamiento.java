 ...
 */
    ...
    /**
     * Método principal para gestionar el caso de uso "Dar de Baja Huésped".
     *
     * Realiza las siguientes verificaciones:
     * 1. Verifica si el huésped alguna vez se alojó (tiene check-in o check-out).
     * Si se alojó, no se permite la baja y se notifica al usuario.
     * 2. Verifica si el huésped existe en la base de datos.
     * Si no existe, se notifica al usuario.
     * 3. Si no se alojó, solicita confirmación para la eliminación.
     * Si el usuario confirma, procede a {@link #eliminarAlojado(Alojado)}.
     *
     * @param alojado Instancia de {@code Alojado} que se desea dar de baja.
     */
