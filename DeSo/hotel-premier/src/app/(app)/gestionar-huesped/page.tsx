...
function GestionarHuespedContent() {
    ...
    if (loading) {
        return <div className="p-10 text-xl font-bold dark:text-white">Cargando datos del huésped...</div>;
    }
    ...
    return (
        <div className="dark:bg-gray-950 dark:text-white">
            ...
            <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6 dark:bg-gray-950 dark:text-white">
                ...
                <div className="flex flex-col">
                    <label className="mb-2 font-semibold text-[#141414] dark:bg-gray-950 dark:text-white">Fecha de nacimiento</label>
                    <input
                        type="date"
                ...
                <div className="flex flex-col md:flex-row justify-between items-center gap-4 pt-8 col-span-1 md:col-span-2 mt-4 border-t border-gray-200 dark:border-gray-800">
                    ...
                    <div className="flex gap-4 w-full md:w-auto justify-end">
                        <button type="button" onClick={() => router.back()} className="px-8 py-2 rounded-xl font-bold transition duration-300 dark:border dark:border-white dark:text-white dark:bg-gray-950 border border-[#1a252f] hover:bg-[#b92716] hover:text-white">
                            Cancelar
                        </button>
                        <button type="submit" className="px-8 py-2 rounded-xl font-bold transition duration-300 bg-[#52a173] text-white hover:bg-[#10b655]">
                            Guardar Cambios
                        </button>
                    </div>
                </div>
