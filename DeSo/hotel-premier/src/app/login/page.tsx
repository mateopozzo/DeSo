...
export default function LoginPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      setPassword("");
      // si querés blanquear también nombre:
      // setNombre("");
    } finally {
      setLoading(false);
    }
  ...
  return (
    <div className="min-h-[calc(100vh-2rem)] flex items-center justify-center">
      <div className="w-full max-w-md rounded-2xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-950 p-6 shadow-sm">
        <h1 className="text-2xl font-semibold mb-2">Hotel Premier</h1>
        <p className="text-sm opacity-80 mb-6">Ingresá para comenzar</p>
