...
export default function ReservarHab() {
  ...
  return (
    <div className="p-6 min-h-screen bg-[#f5f7fa] dark:bg-gray-950 dark:text-white">
      ...
      {error && (
        <div className="bg-red-500 text-white p-4 rounded-xl mb-6 font-bold shadow-md">
          Error: {error}
        </div>
      )}
          ...
          <div className="flex flex-wrap gap-4 items-end bg-[#f5f7fa] dark:bg-gray-950 p-6 rounded-2xl shadow-sm ">
            <div>
              ...
              <input
                ...
                className="px-4 py-2 rounded-xl border border-gray-300 dark:border-gray-700 bg-[#f5f7fa] dark:bg-gray-950 focus:ring-2 focus:ring-green-500 outline-none transition"
              />
            </div>
            <div>
              <label className="block text-sm font-bold mb-2 text-gray-700 dark:text-gray-300">
